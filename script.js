...
var l_messages = [
	"Загружаем аддоны..",
	"Если полоса загрузки стоит на месте - перезапустите гаррисмод",
	"Если стадия (workshop complete) длиться очень долго - перезапустите гаррисмод",
	"Определяем вашу личность",
	"Пишем скрипты...",
	"format C:",
	"Слава целлару!",
	"Возрождаемся...",
	"Здесь могла бы бывать ваша цитата...",
